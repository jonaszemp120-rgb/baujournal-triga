...
console.log('\n=== api/chat-aufraeumen ===');
{
  const pfad = '/home/user/baujournal-triga/api/chat-aufraeumen.js';
...
console.log('\n=== api/push ===');
{
  const pfad = '/home/user/baujournal-triga/api/push.js';
  delete require.cache[require.resolve(pfad)];
  ...
  const { subtle } = require('/home/user/baujournal-triga/api/_webpush.js');
...
console.log('\n=== api/wetter ===');
{
  const pfad = '/home/user/baujournal-triga/api/wetter.js';
